...
describe.each`
    filename              | reverseRows | columnALength | columnBLength
    ${"V1997/test.mdb"}   | ${true}     | ${50}         | ${100}
    ${"V2000/test.mdb"}   | ${false}    | ${100}        | ${200}
    ${"V2003/test.mdb"}   | ${false}    | ${100}        | ${200}
    ${"V2007/test.accdb"} | ${true}     | ${100}        | ${200}
    ${"V2010/test.accdb"} | ${true}     | ${100}        | ${200}
`("$filename", ({ filename, reverseRows, columnALength, columnBLength }) => {
